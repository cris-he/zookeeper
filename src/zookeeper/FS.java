...
public class FileServer {
  ...
  public static void main(String[] args) {
    if (args.length != 2) {
      System.out.println(
          "Usage: java -classpath lib/zookeeper-3.3.2.jar:lib/log4j-1.2.15.jar:. Test zkServer:clientPort port");
      return;
    }
  ...
  private void start() {
    ...
    try {
      ...
      while (listening) {
        new FileServerHandler(serverSocket.accept(), zkc, zk, dictionary)
            .start();
      }
  ...
  private boolean setPrimary() {
    ...
    if (stat == null) { // znode doesn't exist; let's try creating it
      ...
      Code ret =
          zkc.create(myPath,              // Path of znode
